...
//
//  Created by Zikar Nurizky on 30/12/25.
//
...
public actor SpeechRecognizerService: Observable {
    ...
    } // Recognizer error cases
    @MainActor public var transcript: String = "" // Main transcription var holder
